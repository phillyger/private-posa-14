...
public class PingPongRight {
	...
	private static final int MAX_NUMBER_THREADS = 2;
	private static final int MAX_NUMBER_SEMA = 2;
	...
	public static class PlayPingPongThread extends Thread {
		 ...
		 */
		// TODO - You fill in here.
		private final SimpleSemaphore[] mSimpleSemaphores = new SimpleSemaphore[MAX_NUMBER_SEMA];
	...
	public static void process(String startString, String pingString,
		...
		// constructor call.
		mLatch = new CountDownLatch(MAX_NUMBER_THREADS);
