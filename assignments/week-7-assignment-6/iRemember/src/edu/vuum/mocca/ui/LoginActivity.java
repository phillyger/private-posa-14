...
//	Commented out - MAX_SECURITY should not be used.
//	static final int MAX_SECURITY = Integer.MAX_VALUE;
	...
	/*
	 * Replace parameter MAX_SECURITY with the static StorageUtilities.SECURITY_PRIVATE constant.
	 * MAX_SECURITY is defined as Integer.MAX_VALUE.
	 * By using the StorageUtilities.SECURITY_PRIVATE, the getOutputMedia method will ensure that
	 * the data is saved privately.  
	 */
